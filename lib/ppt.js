...
function ppt(commonds, argv) {
	...
	console.log('   ppt a.md --theme=black --transition=zoomv')
	console.log('   ppt https://raw.githubusercontent.com/jirengu/server-mock/master/README.md')
	console.log('----')
	console.log('支持的主题: beige, black, blood, league, moon, night, serif, simple, sky, solarized, white')
	console.log('支持的转场: none, fade, slide, convex, concave, zoom')
